...
if __name__ == '__main__':
    ...
    parser.add_argument("--data-path", type=str, default="/media/hdd/yfliu/datasets/sky_timelapse/sky_train/")
    ...
    taichi_dataloader = data.DataLoader(dataset=taichi_dataset, batch_size=6, shuffle=False, num_workers=1)
