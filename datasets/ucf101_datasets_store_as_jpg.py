...
if __name__ == '__main__':
    ...
    parser.add_argument("--data-path", type=str, default="/home/extradisk/liuyaofang/datasets/UCF101/UCF-101")
    ...
    output_dir = config.data_path + '_fvd1'    # Define the output directory for frames
