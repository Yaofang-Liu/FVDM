...
# def Latte_XL_2(**kwargs):
#     return Latte(depth=14, hidden_size=1152, patch_size=2, num_heads=16, **kwargs)
...
def Latte_T_2(**kwargs):
    return Latte(depth=6, hidden_size=192, patch_size=2, num_heads=3, **kwargs)

def Latte_T_4(**kwargs):
    return Latte(depth=6, hidden_size=192, patch_size=4, num_heads=3, **kwargs)

def Latte_T_8(**kwargs):
    return Latte(depth=6, hidden_size=192, patch_size=8, num_heads=3, **kwargs)
...
Latte_models = {
    ...
    'Latte-T/2':  Latte_T_2,   'Latte-T/4':  Latte_T_4,   'Latte-S/8':  Latte_T_8,
}
...
if __name__ == '__main__':
    ...
    # network = Latte_S_8().to(device)
    # network = Latte_S_2().to(device)
    network = Latte_T_2().to(device)
