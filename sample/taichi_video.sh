...
python sample/sample_video.py \
--config ./configs/taichi/taichi_sample_video_ddpm.yaml \
...
--save_video_path ./results_test_FVD/taichi_0250000_250_sigma_p02_XL &
...
--save_video_path ./results_test_FVD/taichi_0245000_250_sigma_p02_XL &
